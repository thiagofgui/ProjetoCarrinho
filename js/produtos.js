  ...
  produtosGravado.forEach(produto => {
    ...
    if(row != null){
     linha += "<tr>"+
              ...
              "<td id='tdacoes'><button class='btn btn-outline-success' onblur='editarproduto("+produto.id+")'><i class='fa fa-edit'></i></button>"+
              "<button class='btn btn-outline-danger'onblur='apagarproduto("+produto.id+")'><i class='fa fa-trash'></i></button></td>"
            +"</tr>";
    row.innerHTML = linha;        
    }   
